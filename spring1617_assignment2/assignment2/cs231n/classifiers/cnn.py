...
class ThreeLayerConvNet(object):
    ...
    def __init__(self, input_dim=(3, 32, 32), num_filters=32, filter_size=7,
        ...
        self.params['W2'] = np.random.randn(num_filters*conv_h*conv_w//4, hidden_dim) * weight_scale
    ...
    def loss(self, X, y=None):
        ...
        scores, score_cache = affine_forward(fc_out, W3, b3)
        ############################################################################
        #                             END OF YOUR CODE                             #
        ############################################################################
        ...
        dscore, dw3, db3 = affine_backward(dloss, score_cache)
        dhidden, dw2, db2 = affine_relu_backward(dscore, fc_cache)
        dx, dw1, db1 = conv_relu_pool_backward(dhidden, conv_cache)
